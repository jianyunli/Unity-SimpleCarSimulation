Shader "Curve/Toon/RimSpecular" {
Properties {
	_MainTex ("Base (RGB)", 2D) = "white" {}
	_SpecularPower ("Specular Power", Range(1,200)) = 16.0
...
#ifdef LIGHTMAP_ON
v2f_specular_rim vert1(appdata_base_LM v)
#else
v2f_specular_rim vert1(appdata_base v)
#endif
{
    v2f_specular_rim o;
...
fixed4 frag1(v2f_specular_rim i) : COLOR
{
	return CurveToonRim_OutputColorSpecular(i);
}
